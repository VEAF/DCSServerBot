...
zonePersistance['zones'] = {
    ...
    ['NeutralZone']={ ['upgradesUsed']=0,['side']=0,['active']=true,['destroyed']={ },['extraUpgrade']={ },['remainingUnits']={ },['lat_long']={ ['longitude']=38.0,['latitude']=35.0,['altitude']=0 },['firstCaptureByRed']=false,['level']=0,['wasBlue']=false,['triggers']={ ['missioncompleted']=0 } }
}
