...
# Update imports to use plugin module structure
import sys

sys.path.insert(0, str(Path(__file__).parent.parent.parent.parent))

from plugins.foothold.foothold import (
    Connection,
    EjectedPilot,
    Mission,
    Player,
...
def get_fixture_path(relative_path: str) -> Path:
    """Get absolute path to a test fixture relative to the plugin directory."""
    return Path(__file__).parent.parent / "fixtures" / relative_path
...
def test_load_sitac_with_hidden_zones() -> None:
    lua_path = get_fixture_path("test_hidden/Missions/Saves/foothold_hidden_test.lua")
    sitac = load_sitac_from_file(lua_path, "test_server")
...
def test_sitac_campaign_progress_all_red() -> None:
    ...
    lua_path = get_fixture_path("test_progress/foothold_all_red.lua")
    sitac = load_sitac_from_file(lua_path, "test_server")
...
def test_sitac_campaign_progress_all_blue() -> None:
    ...
    lua_path = get_fixture_path("test_progress/foothold_all_blue.lua")
    sitac = load_sitac_from_file(lua_path, "test_server")
...
def test_sitac_campaign_progress_mixed() -> None:
    ...
    lua_path = get_fixture_path("test_progress/foothold_mixed.lua")
    sitac = load_sitac_from_file(lua_path, "test_server")
...
def test_sitac_campaign_progress_with_neutral() -> None:
    ...
    lua_path = get_fixture_path("test_progress/foothold_with_neutral.lua")
    sitac = load_sitac_from_file(lua_path, "test_server")
...
def test_sitac_campaign_progress_no_zones() -> None:
    ...
    lua_path = get_fixture_path("test_progress/foothold_empty.lua")
    sitac = load_sitac_from_file(lua_path, "test_server")
    assert sitac.campaign_progress == 0.0
...
def test_load_sitac_with_missions() -> None:
    ...
    lua_path = get_fixture_path("test_missions/Missions/Saves/foothold_missions.lua")
    sitac = load_sitac_from_file(lua_path, "test_server")
...
def test_load_sitac_with_ejected_pilots() -> None:
    ...
    lua_path = get_fixture_path("test_ejected/Missions/Saves/foothold_ejected.lua")
    sitac = load_sitac_from_file(lua_path, "test_server")
